# pagila-hw
[![](https://github.com/emjuliet/pagila-hw/workflows/tests/badge.svg)](https://github.com/emjuliet/pagila-hw/actions?query=workflow%3Atests)
...
The following picture illustrates the database's structure:i
